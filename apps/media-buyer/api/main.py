...
def get_campaigns():
    return [
        {"name": "Summer Sale - Meta", "platform": "Meta", "status": "Active", "spend": 4280, "budget": 8000, "roas": 3.2, "cpa": 12.40},
        {"name": "Brand Awareness - Google", "platform": "Google", "status": "Active", "spend": 2150, "budget": 5000, "roas": 2.8, "cpa": 18.90},
        {"name": "Retargeting - Meta", "platform": "Meta", "status": "Paused", "spend": 890, "budget": 2000, "roas": 4.1, "cpa": 8.20},
        {"name": "New Launch - TikTok", "platform": "TikTok", "status": "Learning", "spend": 620, "budget": 3000, "roas": 1.4, "cpa": 32.10},
    ]
